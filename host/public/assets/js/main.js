...
$(function() {
  ...
  EMISS.global = {
    ...
    init: function() {
      EMISS.global.deviceSize();
      EMISS.global.layout();
      EMISS.global.animsition();
    },
  ...
  EMISS.navbar = {
    ...
    init: function() {
      EMISS.navbar.menu();
      EMISS.navbar.ripple();
      EMISS.navbar.removeRipple();
      EMISS.navbar.collapse();
      EMISS.navbar.offcanvas();
    },
  ...
  EMISS.extra = {
    ...
    init: function() {
      EMISS.extra.sparklineChart();
      EMISS.extra.slimScroll();
      EMISS.extra.daterangePicker();
      EMISS.extra.easypiechart();
      EMISS.extra.chosen();
      EMISS.extra.toggleClass();
      EMISS.extra.colorpicker();
      EMISS.extra.touchspin();
      EMISS.extra.datepicker();
      EMISS.extra.animateProgress();
      EMISS.extra.counter();
      EMISS.extra.popover();
      EMISS.extra.tooltip();
      EMISS.extra.splash();
      EMISS.extra.lightbox();
    },
    ...
    lightbox: function(){
      ...
      if( $lightboxGalleryEl.length > 0 ) {
        $lightboxGalleryEl.each(function() {
          ...
          if( element.find('a[data-lightbox="gallery-order"]').parent('.clone').hasClass('clone') ) {
            element.find('a[data-lightbox="gallery-order"]').parent('.clone').find('a[data-lightbox="gallery-order"]').attr('data-lightbox','');
          }

          element.magnificPopup({
            delegate: 'a[data-lightbox="gallery-order"]',
            type: 'image',
            closeOnContentClick: true,
            closeBtnInside: false,
            fixedContentPos: true,
  ...
  EMISS.isMobile = {
    ...
    any: function() {
      return (EMISS.isMobile.Android() || EMISS.isMobile.BlackBerry() || EMISS.isMobile.iOS() || EMISS.isMobile.Opera() || EMISS.isMobile.Windows());
    }
  };
  ...
  EMISS.documentOnResize = {

    init: function(){

      var t = setTimeout( function(){

        EMISS.documentOnReady.setSidebar();
        EMISS.navbar.removeRipple();
  ...
  EMISS.documentOnReady = {

    init: function(){
      EMISS.global.init();
      EMISS.header.init();
      EMISS.navbar.init();
      EMISS.documentOnReady.windowscroll();
      EMISS.tiles.init();
      EMISS.extra.init();
      EMISS.documentOnReady.setSidebar();
    },
  ...
  // initializing
  //!!!!!!!!!!!!!
  $(document).ready( EMISS.documentOnReady.init );
  $window.load( EMISS.documentOnLoad.init );
  $window.on( 'resize', EMISS.documentOnResize.init );
