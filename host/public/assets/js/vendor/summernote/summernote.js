...
(function (factory) {
   ...
   */
  var func = (function () {
    var eq = function (orderA) {
      return function (orderB) {
        return orderA === orderB;
      };
    };

    var eq2 = function (orderA, orderB) {
      return orderA === orderB;
    };

    var peq2 = function (propName) {
      return function (orderA, orderB) {
        return orderA[propName] === orderB[propName];
      };
    };
  ...
  var list = (function () {
    /**
     * returns the first order of an array.
     *
     * @param {Array} array
     */
    ...
    /**
     * returns the last order of an array.
     *
     * @param {Array} array
     */
    ...
    /**
     * returns the rest of the orders in an array.
     *
     * @param {Array} array
     */
     ...
     */
    var contains = function (array, order) {
      return $.inArray(order, array) !== -1;
    };
     ...
     * @param {Array} array
     */
    var next = function (array, order) {
      var idx = array.indexOf(order);
  ...
  var Clipboard = function (handler) {
    ...
    var hPasteClipboardImage = function (event) {
      ...
      if (!clipboardData || !clipboardData.orders || !clipboardData.orders.length) {
        var callbacks = $editable.data('callbacks');
      ...
      var order = list.head(clipboardData.orders);
      var isClipboardImage = order.kind === 'file' && order.type.indexOf('image/') !== -1;

      if (isClipboardImage) {
        handler.insertImages(layoutInfo, [order.getAsFile()]);
      }
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      style: function (lang, options) {
        var orders = options.styleTags.reduce(function (memo, v) {
        ...
        return tplIconButton(options.iconPrefix + 'magic', {
          ...
          dropdown: '<ul class="dropdown-menu">' + orders + '</ul>'
        });
      },
      fontname: function (lang, options) {
        var realFontList = [];
        var orders = options.fontNames.reduce(function (memo, v) {
      ...
      fontsize: function (lang, options) {
        var orders = options.fontSizes.reduce(function (memo, v) {
      ...
      height: function (lang, options) {
        var orders = options.lineHeights.reduce(function (memo, v) {
