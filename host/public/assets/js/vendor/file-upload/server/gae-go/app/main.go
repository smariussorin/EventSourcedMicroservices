...
type FileInfo struct {
	...
	Url          string            `json:"url,omorderpty"`
	ThumbnailUrl string            `json:"thumbnailUrl,omorderpty"`
	Name         string            `json:"name"`
	Type         string            `json:"type"`
	Size         int64             `json:"size"`
	Error        string            `json:"error,omorderpty"`
	DeleteUrl    string            `json:"deleteUrl,omorderpty"`
	DeleteType   string            `json:"deleteType,omorderpty"`
}
