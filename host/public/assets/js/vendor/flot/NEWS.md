...
### Bug fixes ###
 ...
 - Fixed problem with findNearbyOrder and bars on top of each other. (reported
 ...
 - Listen for mouseleave events and fire a plothover event with empty
   order when it occurs to drop highlights when the mouse leaves the
 ...
 - Fix bug in picking orders when transform/inverseTransform is in use
...
## Bug fixes ##
 ...
 - Fixed bug with slicing in findNearbyOrders. (patch by zollman)
...
event now returns the closest data order (based on patch by /david, patch by
...
## Bug fixes ##
 ...
 - Fixed a bug in handling single-order bar series. (reported by Emil Filipov)
